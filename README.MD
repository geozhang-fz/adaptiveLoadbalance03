...
- [adaptive-loadbalance](https://code.aliyun.com/middlewarerace2019/adaptive-loadbalance)
    ...
    ```
    git clone https://code.aliyun.com/middlewarerace2019/adaptive-loadbalance
...
- geozhang: 
  ...
  - ① 修改 InitProviderService.java 的 getInitStubs方法中的IP地址为本机的IP地址
  - ② 修改 InitProviderService.java 的 buildUrls方法中的IP地址为本机的IP地址
  - ③ run configuration 中要指定参数，运行启动三个providers才行（即图中“large”外还有“medium”和“small”）
  
  ![屏幕快照 2020-08-09 下午11.11.12](/Users/geozhang/Documents/java_work/adaptiveLoadbalance02/pic/屏幕快照 2020-08-09 下午11.11.12.png)
...
```
cd adaptiveLoadbalance02/internal-service
...
https://code.aliyun.com/geozhang_fz/adaptive-loadbalance/project_members

评测地址  https://tianchi.aliyun.com/competition/entrance/231740/introduction
